...
int main(){
    ...
    while (!in_file.eof()){
        ...
        switch (choice){
            ...
            case 'p': 
                ...
                cout<<p_in.baby<<endl;
                cout<<p_in.child<<endl;
                cout<<p_in.adult<<endl;
                cout<<p_in.senior<<endl;
                cout<<p_in.female<<endl;
                cout<<p_in.male<<endl;
    ...
    for (int m =0; m < eth; m++){
    e_out = city1.get_eth();
    cout<<e_out.name<<endl;
    cout<<e_out.percent<<endl;
    }
    return 0;
}
